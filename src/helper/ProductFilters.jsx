      ...
      <div className={`${isMobileFiltersOpen ? "block" : "hidden"} md:block`}>
        <div className="flex flex-col md:flex-row md:flex-wrap md:items-center gap-4">
          ...
          <div className="relative w-full md:w-auto">
            ...
            {isDropdownOpen && (
              <div className="absolute z-10 mt-2 w-full md:w-64 bg-white rounded-md shadow-lg">
                <div className="py-1">
                  <button
          ...
          <div className="relative w-full md:w-auto">
            ...
            {isSortDropdownOpen && (
              <div className="absolute right-0 z-10 mt-2 w-full md:w-48 bg-white rounded-md shadow-lg">
                <div className="py-1">
                  <button
